...
# When OS 2 is running we get the print message "no update needed" 
# When running system = "OS 1" no output on the print message 
...
# When system = "OS 2" is running we get the out "update needed"
# But when we change the variable system = "OS 1" or system = "OS 3" the output says "update needed" 
...
# When system = "OS 2" and system = "OS 3" the output shows "no update needed"
# When system = "OS 1" the update is needed
# 
# I switched the variable for system = "OS 4" and there is no output to designate if an "update is needed" or "no update is needed"
...
if system == "OS 2":
    print("no update needed")
elif system == "OS 3" or system == "OS 1":
    print("update needed")
...
# Specifically for the elif logical operator, it's really essential to use the or command where it helps in order to combine to elif statements and make it simple on the logical operation. 
...
approved_list = ["elarson", "tshah", "sgilmore", "eraab"]
...
if username in approved_list:
    print ("approved access to this device")
else:
    print ("access denied")
...
# When approved users log in they are granted access. 
# 
# After removing bmoreno from the approved list and running the script again we get an output on the else statement that access is denied for bmoreno
...
# When the user logs in during organization hours the script indicates that a "Login attempt made during organization hours"
# When switching the variable to False we get "Login attempt made outside of organization hours"
...
# For username I assigned username = "gdelrosario" this not an approved user in the approved list, the boolean value for organization_hours = False. When running the script we get the output:
# 
...
# For an approved user, we get the output  "Login attempt made by an approved user during organization hours."
# 
# After putting a username not included in the approval_list to specifiy the specific user trying to log i. We get the output "Username not approved or login attempt made outside of organization hours."
# 

# ## Conclusion
# **What are your key takeaways from this lab?**
# 
# Python is an essential skill of the 21st century
# 
# "Hello World!"
# 
