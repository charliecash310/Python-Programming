...
# It's a comment, therefore there is not output. 
...
# It prints exactly what was intended to print and does not include the comment string.
...
# With a little edit and inpute it's no different than the last example printed exactly what was asked. 
...
print("Hello world!")
print("I am using Python.")
print("While working Front Desk!")
print("Really need to move on and find another job!")
...
# Very fundamental for starting off on Python
