...
# The output is in sequential order. However, we can see there are more than 100 login attempts per month. 
...
# print(max(failed_login_list)) = 264
...
# For all the other tasks, I was not able to have any output. But in this case, we can see that we have 3x lines to make known the Current day login total, Average logins per day, and returning the ratio of login_analysis.
...
# This lab was very useful. However, I did not have any outputs when running the code in order to understand the purpose behind the code and why it runs this specific output. Went through all the examples/hints, pretty certain I did exactly what was asked based on where the code needed to be inputted. 
