...
# In this case if you put device_id without the quotations it allows the re-assign the variable above and helps define the assignment for (device_id_type)
...
username_list_type = username_list
...
# Displays 2 Lines. The new string to update username such as lpope is displayable when running the script. 
...
# max_logins = 3 displays that we are going to output a whole number or rather an integer which is the data type shown. 
...
# Starting from login_attempts = 2 as assigned from above, we define the variable login_attempts and eventually come to the output displaying <class 'int'>
...
# login_attempts =2 <= max_logins = 3. 2 is less than or equal to 3. This logical condition in the Boolean does display that this value is True
...
# For the variable login_attempts, I added a value of 17 displayed as login_attempts = 17. After running the code we get a Boolean output for False as the number of login_attempts is not less than or equal to the number of max_logins. 
...
# <class 'bool'> is displayed when running the variable login_status. 

# ## Conclusion
# 
# **What are your key takeaways from this lab?**

# I've interacted with python before. I know there is alot of documentation, and these examples have really helped simplify it's application for it's real-life use. Eventually after this course I plan to pick up more on python and stay dedicated to using this language, I really like the examples it feels elementary but they're very fundamental and essential for all that is to come. 
